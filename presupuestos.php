...
.encabezado p {
    ...
    ' . ($base64 ? '<img src="' . $base64 . '" style="width:150px; height:250px; margin-bottom: 10px;" alt="Logo">' : '') . '
        <h1>Presupuesto</h1>
   ...
   ' . ($base64 ? '<img src="' . $base64 . '" style="width:120px; height:400px; margin-top: 15px;" alt="Logo">' : '') . '
</div>';
